...
public class ICONUtil {
	...
	public static String formatBackgroundIamgeURL(String url){
	...
	public static BufferedImage scaleImage(String url ) throws Exception {
		BufferedImage output = new BufferedImage(16, 16,
				BufferedImage.TRANSLUCENT);
		Image image = ImageIO.read(new URL(url)).getScaledInstance(
